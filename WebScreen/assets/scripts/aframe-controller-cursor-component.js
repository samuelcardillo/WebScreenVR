...
AFRAME.registerComponent('controller-cursor', {
  ...
  play: function () {
    ...
    cursorEl.addEventListener('Adown', this.onTriggerDownBind);
    cursorEl.addEventListener('Aup', this.onTriggerUpBind);
  },
  ...
  pause: function () {
    ...
    cursorEl.removeEventListener('raycaster-intersection-cleared',
                                 this.onIntersectionClearedBind);
    cursorEl.removeEventListener('Adown', this.onTriggerDownBind);
    cursorEl.removeEventListener('Aup', this.onTriggerUpBind);
  },
